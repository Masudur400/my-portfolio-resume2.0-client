  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <Card className="custom-card animate-float px-5 py-6 group hover:scale-105 transition-transform duration-300 bg-gradient-to-br from-gray-900/5 via-gray-800 to-black/5 rounded-xl  border-2">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 lg:grid-cols-8 xl:grid-cols-9 gap-4   mx-auto my-16">
          {gridItems.map((item) => (
            <div
              ...
              className={`w-fit custom-card animate-float mx-auto md:px-4 md:py-2 px-6 py-2 border-2 bg-gradient-to-br from-gray-900/5 via-gray-800 to-black/5 border-gray-600 hover:shadow-indigo-800 hover:shadow-md rounded text-center cursor-move ${item.id === draggedItem?.id && "bg-blue-100 opacity-30"
