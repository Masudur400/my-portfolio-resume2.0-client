                ...
                <div className="avg w-full max-sm:h-[680px]">
                    <div className='h-full'>
                        <div className='md:flex gap-9 lg:gap-24 items-center'>
                            <Image src={img1} alt="" data-aos="zoom-in" className='h-72 w-72 lg:h-96 lg:w-96 border-2 border-indigo-700 rounded-full lg:ml-20 md:ml-10 md:mx-1 mx-auto md:mt-8 hover:scale-105 transition-transform duration-300' />
