...
const Banner = () => {
    return (
        <div className="">
            <Card className="bg-gradient-to-br from-gray-900/5 via-gray-800 to-black/5 border shadow-lg  ">
                        ...
                        <div className='md:flex gap-9 lg:gap-24 items-center'>
                            ...
                            <div className='text-white text-opacity-80 opacity-90 max-sm:ml-4 lg:w-3/6 md:w-2/4 mt-3 flex flex-col gap-5'>
                                <div>
                                    ...
                                    <p className='lg:text-4xl md:text-3xl text-2xl font-bold lg:ml-12 md:ml-12 mb-3'>I am <span className="bg-gradient-to-r from-blue-500 via-indigo-600 to-blue-700 bg-clip-text text-transparent animate-gradient-x transition-transform duration-300 group-hover:scale-110 ">Masudur Rahman</span></p>
                                </div>
