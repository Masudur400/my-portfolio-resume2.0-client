    ...
    >
      ...
      <div className="space-y-6">
        ...
        <Button
          ...
          disabled={loading} 
          size="lg"
          className="w-full mt-6 text-white bg-gradient-to-r from-blue-600 via-indigo-700 to-blue-800 hover:from-blue-700 hover:via-indigo-800 hover:to-blue-900 hover:to-blue-800"
        >
          {loading ? (
