    ...
    <div>
      <section className="my-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="custom-card animate-float hover:shadow-lg hover:scale-105 transition-transform duration-300 bg-gradient-to-br from-gray-900/5 via-gray-800 to-black/5 border-2">
            <CardHeader>
          ...
          <Card className="custom-card animate-float hover:scale-105 transition-transform duration-300 bg-gradient-to-br from-gray-900/5 via-gray-800 to-black/5">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
            ...
            <CardContent>
              <p className="text-gray-400">
                Passionate about discovering and learning new technologies.
              </p>
            </CardContent>
          </Card>
