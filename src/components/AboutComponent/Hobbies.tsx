...
const Hobbies = () => {
    return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="hover:shadow-lg hover:scale-105 transition-transform duration-300 bg-gradient-to-br from-gray-900/5 via-gray-800 to-black/5 shadow-lg shadow-indigo-800">
          <CardHeader>
